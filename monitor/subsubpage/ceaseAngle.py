...
class CeaseAnglePage(tk.Frame):
    def __init__(self, master, controller):
        ...
        # Title
        label_title = tk.Label(self, text="停止模式角度設定", font=("Helvetica", 20))
        ...
        # 警示文字
        self.alert_label = tk.Label(center_frame, text=f"停止模式角度為{self.slider.get()}度", font=("Helvetica", 18), fg="red")
